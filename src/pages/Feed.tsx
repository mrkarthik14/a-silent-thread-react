...
export default function Feed() {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-blue-50 dark:from-yellow-100 dark:via-yellow-100 dark:to-yellow-100 transition-colors duration-500">
      <Sidebar />
      
      <div className="flex-1 overflow-y-auto feed-scroll bg-gradient-to-br from-slate-50 via-purple-50 to-blue-50 dark:from-yellow-100 dark:via-yellow-100 dark:to-yellow-100 transition-colors duration-500">
